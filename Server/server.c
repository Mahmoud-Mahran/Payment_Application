...
EN_transState_t recieveTransactionData(ST_transaction_t* transData)
{
	...
	if (FuncRet == APPROVED)
	{
		...
		printf("########################\n\n");
		/////////////updating account balance in file///////////////
		...
		sprintf_s(Local_charBuffer, 100, "%0.3f,%d,\"%s\"\n", Local_uddtAccountReference.balance, Local_uddtAccountReference.state, Local_uddtAccountReference.primaryAccountNumber);
		/*      write to  file      */
